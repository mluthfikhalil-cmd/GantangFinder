-- Seed dummy users and make them look active in the app
-- This creates fake engagement to make the app look alive

-- 1. First create the users
INSERT INTO users (id, username, password_hash, nama_lengkap, wa_number, created_at) VALUES
('11111111-1111-1111-1111-111111111111', 'admin123', 'cGFzc3EyMzQ=', 'Admin GantangFinder', '6281234567890', '2026-01-15 08:00:00+00'),
('22222222-2222-2222-2222-222222222222', 'organizer01', 'aWN1d2FuZzIwMjY=', 'H. Iwan Setiawan', '6282345678901', '2026-02-01 09:00:00+00'),
('33333333-3333-3333-3333-333333333333', 'kicau_master', 'YnVydW5nMTIz', 'Bpk. Budi Santoso', '6283456789012', '2026-02-10 10:00:00+00'),
('44444444-4444-4444-4444-444444444444', 'merpati_aceh', 'YWNlaDIwMjY=', 'Tgk. M. Amin', '6285678901234', '2026-02-15 11:00:00+00')
ON CONFLICT (username) DO NOTHING;

-- 2. Link existing events to organizers (update existing events to have organizer_id)
...
-- 3. Add subscribers (fake subscriptions to get notified)
...
-- For Merpati Sprint Palembang (May 30, 2026)
